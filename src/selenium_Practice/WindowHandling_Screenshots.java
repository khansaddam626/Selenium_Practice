...
public class WindowHandling_Screenshots {
	WebDriver driver;
	@BeforeClass
	...
	public void windowsHandling() throws InterruptedException {
		...
		dataPolicy.click();
		WebElement cookies = driver.findElement(By.partialLinkText("Cook"));
		cookies.click();
		Set<String> allHandles = driver.getWindowHandles();
		ArrayList<String> handles = new ArrayList<String>(allHandles);
		//String signUpPage = handles.get(0);
		String termsPage = handles.get(0);
		String dataPolicyPage = handles.get(1);
		String cookiesPage = handles.get(2);
		Thread.sleep(3000);

		driver.switchTo().window(termsPage);
		driver.switchTo().window(cookiesPage);
	}
	@Test
